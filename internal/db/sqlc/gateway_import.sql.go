...
const upsertGatewayForBulkImport = `-- name: UpsertGatewayForBulkImport :one
...
type UpsertGatewayForBulkImportParams struct {
	GatewayID   string
	Name        string
	Description *string
	Region      string
...
type UpsertGatewayForBulkImportRow struct {
	ID               pgtype.UUID
	GatewayID        string
	Name             string
	Description      *string
...
func (q *Queries) UpsertGatewayForBulkImport(ctx context.Context, arg UpsertGatewayForBulkImportParams) (UpsertGatewayForBulkImportRow, error) {
	row := q.db.QueryRow(ctx, upsertGatewayForBulkImport,
		arg.GatewayID,
		arg.Name,
		arg.Description,
		arg.Region,
	...
	var i UpsertGatewayForBulkImportRow
	err := row.Scan(
		&i.ID,
		&i.GatewayID,
		&i.Name,
